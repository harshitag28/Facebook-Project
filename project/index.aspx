    ...
    <div class="st-pusher" id="content">
      ...
      <div class="st-content">
          ...
          <nav class="navbar navbar-subnav navbar-static-top" role="navigation">
           ...
           <div class="container">
             <div class="row">
                ...
                <div class="avatar" id="propic" runat="server">
                  
                </div>
                <div class="name">
                    <asp:LinkButton ID="LinkButton12" runat="server" OnClick="LinkButton12_Click" Font-Size="Medium"></asp:LinkButton>

                </div>
                <ul class="cover-nav">

                  <asp:LinkButton ID="LinkButton10" OnClick="LinkButton3_Click" runat="server"><i class="fa fa-fw icon-ship-wheel"></i> My Timeline</asp:LinkButton><br />
                
                  <asp:LinkButton ID="LinkButton11" OnClick="LinkButton5_Click" runat="server"><i class="fa fa-fw fa-users"></i> Friends</asp:LinkButton>

                </ul>
                
                <div class="timeline-block">
                  <div class="panel panel-default relative">
                    <h3 style="font-family:Arial;text-align:center">Followers</h3>
                    <hr />
                    <div class="panel-body" id="dispfollow" runat="server">
                ...
                <div class="timeline-block">
                    <div class="panel panel-default share clearfix-xs">
                     ...
                     <div class="row">
                         <div class="col-xs-12 col-md-12 col-sm-12 item" id="wall" runat="server">
                  </div>
                     </div>
        ...
        <!-- /st-content-inner -->
                ...
                <div class="timeline-block" id="Div1" runat="server">
                           <div class="panel panel-default share clearfix-xs">
                        <div class="panel-heading panel-heading-gray title">
                            <h1>Friends</h1>
                        </div>
